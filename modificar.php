...
?>
	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form action="guardarCambios.php?id=<?php echo $row['id_servicio']; ?>" method="post" enctype="multipart/form-data">
					    <div class="form-group col-md-2">
					      <label for="id_servicio" style="color:#1E355E";>Número de folio</label>
						      ...
						      value="<?php echo $row['id_servicio']; ?>" disabled
						      >
						    </div>
					<div class="form-row">
					    <div class="form-group col-md-6">
					      <label for="descservicio" style="color:#1E355E";>Descripcion de servicio</label>
						      <input type="text" class="form-control" name="descservicio" id="descservicio"  value="<?php echo $row['desc_servicio']; ?>" required>
						    </div>
						 
						    <div class="form-group col-md-6">
						      <label for="dpto" style="color:#1E355E";>Departamento que lo solicita</label>
						      <select id="dpto" name="dpto" class="form-control">
						      	<option value="<?php echo $row['nombre_dpto']; ?>"><?php echo $row['nombre_dpto']; ?></option>
						 ...
						 <div class="input-group form-group">
					      ...
					      <label for="respservicio" style="color:#1E355E";>Responsable del servicio</label>
						      <input type="text" class="form-control" name="respservicio" id="respservicio"  value="<?php echo $row['nombre_responsable']; ?>" required>
						    </div>
						    <div class="form-group col-md-6">
					      <label for="nombresol" style="color:#1E355E";>Nombre del solicitante</label>
						      <input type="text" class="form-control" name="nombresol" id="nombresol"  value="<?php echo $row['nombre_solicitante']; ?>" required>
						    </div>
						  <div class="form-group col-md-6">
						    <label for="fechaInicio" style="color:#1E355E";>Fecha de solicitud</label><br>
						      <input type="date" name="fechaInicio" min="2000-01-01"
                                  max="2019-12-31"  value="<?php echo $row['fecha_solicitud']; ?>"required>
						  </div>
						  <div class="form-group col-md-6" align="center">
						    <label for="nombreimg" style="color:#1E355E";>Evidencia</label><br>
						   
						     <img src="data:image/jpg;base64,<?php echo base64_encode($row['img']); ?>" width="80%"/>

						  </div>
						  <div class="form-group col-md-6">
						    <label for="fechaFinal" style="color:#1E355E";>Fecha de realización</label><br>
						    <input type="date" name="fechaFinal" min="2000-01-01"
                                  max="2019-12-31"  value="<?php echo $row['fecha_realizacion']; ?>">
						  </div>
						  					    <div class="form-group col-md-6">
					      <label for="obs_servicio" style="color:#1E355E";>Observaciones</label>
						      <input type="text" class="form-control" name="obs_servicio" id="obs_servicio"  value="<?php echo $row['observaciones']; ?>" required>
						    </div>
